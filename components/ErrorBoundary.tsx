...
// FIX: To function as a React class component, `ErrorBoundary` must extend `React.Component`. This provides access to component lifecycle methods, `this.props`, and `this.setState`.
