...
export const createConfiguredMathParser = (functions: { [key: string]: G3DFunction }): Parser => {
    ...
    const aliases: { [key: string]: string } = { 'SIN': 'sin', 'COS': 'cos', 'TAN': 'tan', 'ASIN': 'asin', 'ACOS': 'acos', 'ATAN': 'atan', 'ATAN2': 'atan2', 'ATN2': 'atan2', 'SQRT': 'sqrt', 'LOG': 'log', 'EXP': 'exp', 'POW': 'pow', 'ABS': 'abs', 'PI': 'pi', 'RAND': 'random' };
